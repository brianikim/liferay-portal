...
export default async function CommerceCheckoutStep() {
	...
	const oauth = Liferay.OAuth2Client.FromUserAgentApplication("liferay-commerce-paypal-checkout-step-oauth-application-user-agent")

	const response = await oauth.fetch("/render", {method: "get"});
