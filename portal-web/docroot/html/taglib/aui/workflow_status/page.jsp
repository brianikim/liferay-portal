...
<span class="taglib-workflow-status">
	...
	<span class="workflow-status">
		...
		<span class="label label-<%= WorkflowConstants.getStatusStyle(status) %> status workflow-status-<%= WorkflowConstants.getStatusLabel(status) %> <%= WorkflowConstants.getStatusCssClass(status) %> workflow-value" data-qa-id="<%= WorkflowConstants.getStatusLabel(status) %>">
