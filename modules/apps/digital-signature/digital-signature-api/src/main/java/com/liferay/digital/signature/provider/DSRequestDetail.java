...
/**
 * The per-document signature status detail: the request-level roll-up plus each
 * recipient's status, used to render the drill-in side panel from the Document
 * Library signature status column.
 *
 * @author Brian Kim
 */
