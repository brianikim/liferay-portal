...
/**
 * Provides the local service utility for CommerceDiscountEntryCheck. This utility wraps
 * <code>com.liferay.commerce.discount.service.impl.CommerceDiscountEntryCheckLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CommerceDiscountEntryCheckLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.commerce.discount.service.impl.CommerceDiscountEntryCheckLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static CommerceDiscountEntryCheck addCommerceDiscountEntryCheck(
		CommerceDiscountEntryCheck commerceDiscountEntryCheck) {

		return getService().addCommerceDiscountEntryCheck(
	 ...
	 */
	public static CommerceDiscountEntryCheck createCommerceDiscountEntryCheck(
		long commerceDiscountEntryCheckId) {

		return getService().createCommerceDiscountEntryCheck(
	 ...
	 */
	public static CommerceDiscountEntryCheck deleteCommerceDiscountEntryCheck(
		CommerceDiscountEntryCheck commerceDiscountEntryCheck) {

		return getService().deleteCommerceDiscountEntryCheck(
			commerceDiscountEntryCheck);
	}
	...
	public static void deleteCommerceDiscountEntryChecks(
			long commerceDiscountId)
		throws PortalException {

		getService().deleteCommerceDiscountEntryChecks(commerceDiscountId);
	}
	...
	public static void deleteCommerceDiscountEntryChecks(
		...
		getService().deleteCommerceDiscountEntryChecks(
	...
	public static CommerceDiscountEntryCheck fetchCommerceDiscountEntryCheck(
		long commerceDiscountEntryCheckId) {

		return getService().fetchCommerceDiscountEntryCheck(
			commerceDiscountEntryCheckId);
	}
	 ...
	 * @throws PortalException if a commerce discount entry check with the primary key could not be found
	 */
	public static CommerceDiscountEntryCheck getCommerceDiscountEntryCheck(
			long commerceDiscountEntryCheckId)
		throws PortalException {

		return getService().getCommerceDiscountEntryCheck(
			commerceDiscountEntryCheckId);
	}
	 ...
	 */
	public static List<CommerceDiscountEntryCheck>
		getCommerceDiscountEntryChecks(int start, int end) {

		return getService().getCommerceDiscountEntryChecks(start, end);
	}
	 ...
	 */
	public static int getCommerceDiscountEntryChecksCount() {
		return getService().getCommerceDiscountEntryChecksCount();
	}
	 ...
	 */
	public static CommerceDiscountEntryCheck updateCommerceDiscountEntryCheck(
		CommerceDiscountEntryCheck commerceDiscountEntryCheck) {

		return getService().updateCommerceDiscountEntryCheck(
			commerceDiscountEntryCheck);
	}

	public static CommerceDiscountEntryCheckLocalService getService() {
		return _service;
	}

	public static void setService(
		CommerceDiscountEntryCheckLocalService service) {

		_service = service;
	}

	private static volatile CommerceDiscountEntryCheckLocalService _service;
