...
/**
 * Provides the local service interface for CommerceDiscountEntryCheck. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marco Leo
 * @see CommerceDiscountEntryCheckLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CommerceDiscountEntryCheckLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.commerce.discount.service.impl.CommerceDiscountEntryCheckLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the commerce discount entry check local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CommerceDiscountEntryCheckLocalServiceUtil} if injection and service tracking are not available.
	 */
