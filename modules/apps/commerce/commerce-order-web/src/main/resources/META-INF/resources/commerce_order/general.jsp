...
<div class="row">
		...
		>
			<div class="row vertically-divided">
				<div class="col-xl-3">
					...
					<commerce-ui:info-box
						actionLabel='<%= commerceOrderEditDisplayContext.hasManageCommerceOrdersPermission() ? LanguageUtil.get(request, Validator.isNull(purchaseOrderNumber) ? "add" : "edit") : null %>'
						actionTargetId="purchase-order-number-modal"
						actionUrl="<%= commerceOrderEditDisplayContext.hasManageCommerceOrdersPermission() ? editPurchaseOrderNumberURL: null %>"
						elementClasses="py-3"
						title='<%= LanguageUtil.get(request, "purchase-order-number") %>'
					>
						<c:choose>
				...
				<div class="col-xl-3">
					...
					<commerce-ui:info-box
						actionLabel='<%= commerceOrderEditDisplayContext.hasManageCommerceOrdersPermission() ? LanguageUtil.get(request, (billingCommerceAddress == null) ? "add" : "edit") : null %>'
						actionTargetId="billing-address-modal"
						actionUrl="<%= commerceOrderEditDisplayContext.hasManageCommerceOrdersPermission() ? editBillingAddressURL: null %>"
						elementClasses="py-3"
					...
					<commerce-ui:info-box
						actionLabel='<%= commerceOrderEditDisplayContext.hasManageCommerceOrdersPermission() ? LanguageUtil.get(request, (shippingCommerceAddress == null) ? "add" : "edit") : null %>'
						actionTargetId="shipping-address-modal"
						actionUrl="<%= commerceOrderEditDisplayContext.hasManageCommerceOrdersPermission() ? editShippingAddressURL: null %>"
						elementClasses="py-3"
				...
				<div class="col-xl-3">
					...
					<commerce-ui:info-box
						actionLabel='<%= commerceOrderEditDisplayContext.hasManageCommerceOrdersPermission() ? LanguageUtil.get(request, (requestedDeliveryDate == null) ? "add" : "edit") : null %>'
						actionTargetId="requested-delivery-date-modal"
						actionUrl="<%= commerceOrderEditDisplayContext.hasManageCommerceOrdersPermission() ? editRequestedDeliveryDateURL: null %>"
						elementClasses="py-3"
						title='<%= LanguageUtil.get(request, "requested-delivery-date") %>'
					>
						<c:choose>
				...
				<div class="col-xl-3">
					<commerce-ui:info-box
						actionLabel='<%= commerceOrderEditDisplayContext.hasManageCommerceOrdersPermission() ? LanguageUtil.get(request, Validator.isNull(printedNote) ? "add" : "edit") : null %>'
						actionTargetId="printed-note-modal"
						actionUrl="<%= commerceOrderEditDisplayContext.hasManageCommerceOrdersPermission() ? editPrintedNoteURL: null %>"
						elementClasses="py-3"
						title='<%= LanguageUtil.get(request, "printed-note") %>'
					>
						<c:choose>
	...
	<div class="col-12">
		...
		<commerce-ui:panel
			actionLabel='<%= commerceOrderEditDisplayContext.hasManageCommerceOrdersPermission() ? LanguageUtil.get(request, "edit") : null %>'
			actionTargetId="order-summary-modal"
			actionUrl="<%= commerceOrderEditDisplayContext.hasManageCommerceOrdersPermission() ? editOrderSummaryURL : null %>"
			title='<%= LanguageUtil.get(request, "order-summary") %>'
		>
