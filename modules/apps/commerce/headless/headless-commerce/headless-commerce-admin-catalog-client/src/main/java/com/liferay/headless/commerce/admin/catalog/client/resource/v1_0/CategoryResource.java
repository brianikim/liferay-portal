...
public interface CategoryResource {
	...
	public HttpInvoker.HttpResponse
			postProductByExternalReferenceCodeCategoryHttpResponse(
				String externalReferenceCode, Category category)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postProductIdCategoryHttpResponse(
			Long id, Category category)
		throws Exception;

	public void postProductIdCategoryBatch(
			Long id, String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse postProductIdCategoryBatchHttpResponse(
			Long id, String callbackURL, Object object)
		throws Exception;
	...
	public static class CategoryResourceImpl implements CategoryResource {
		...
		public Category postProductIdCategory(Long id, Category category)
			...
			HttpInvoker.HttpResponse httpResponse =
				postProductIdCategoryHttpResponse(id, category);
		...
		public void postProductIdCategoryBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postProductIdCategoryBatchHttpResponse(id, callbackURL, object);
		...
		public HttpInvoker.HttpResponse postProductIdCategoryBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/products/categories/batch");
