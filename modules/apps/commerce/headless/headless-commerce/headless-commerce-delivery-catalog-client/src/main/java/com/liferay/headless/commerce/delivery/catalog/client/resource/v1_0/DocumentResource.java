...
public interface DocumentResource {
	...
	public HttpInvoker.HttpResponse getAttachmentIdDocumentHttpResponse(Long id)
		throws Exception;
	...
	public static class DocumentResourceImpl implements DocumentResource {
		...
		public Document getAttachmentIdDocument(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				getAttachmentIdDocumentHttpResponse(id);
			...
			try {
				return com.liferay.headless.commerce.delivery.catalog.client.
					serdes.v1_0.DocumentSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse getAttachmentIdDocumentHttpResponse(
				Long id)
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-catalog/v1.0/attachments/{id}/document");
