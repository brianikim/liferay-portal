...
public abstract class BaseDocumentResourceImpl implements DocumentResource {
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-delivery-catalog/v1.0/attachments/{id}/document'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/attachments/{id}/document")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Document getAttachmentIdDocument(
