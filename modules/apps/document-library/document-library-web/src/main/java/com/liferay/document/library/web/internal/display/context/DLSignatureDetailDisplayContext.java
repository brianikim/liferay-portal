...
/**
 * Backs the signature status detail section of the Document Library info panel:
 * resolves the per-document detail from the optional {@link
 * DSRequestDetailProvider} and derives the recipient statuses and signing
...
public class DLSignatureDetailDisplayContext {
	...
	public DLSignatureDetailDisplayContext(
		long companyId, DSRequestDetailProvider dsRequestDetailProvider,
		long fileEntryId, HttpServletRequest httpServletRequest, Locale locale,
		TimeZone timeZone) {

		_companyId = companyId;
		_dsRequestDetailProvider = dsRequestDetailProvider;
	...
	public DSRequestDetail getDSRequestDetail() {
		...
		if (_dsRequestDetailProvider == null) {
			return null;
		}

		_dsRequestDetail = _dsRequestDetailProvider.getRequestDetail(
	...
	public boolean isSignatureDetailVisible() {
		if (getDSRequestDetail() != null) {
			return true;
		}
	...
	private final DSRequestDetailProvider _dsRequestDetailProvider;
